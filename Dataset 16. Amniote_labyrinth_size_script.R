...
###Set working directory where amniote data (Dataset S13. Amniote labyrinth data) is stored
	...
	## Load slider info
		...
		setwd( "INSERT DIRECTORY PATH" )
		sliders <- read.csv("Dataset S15. sliders.amniotes.csv", row.names=1)

	#Load specimen information
		setwd( "INSERT DIRECTORY PATH" )
		specimen.info <- read.csv( "Dataset S13. specimen.info.amniotes.csv", header = TRUE )
