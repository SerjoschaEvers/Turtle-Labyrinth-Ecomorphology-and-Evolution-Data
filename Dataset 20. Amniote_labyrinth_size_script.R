...
###Set working directory where amniote data (Dataset 18. Amniote labyrinth data) is stored
	...
	## Load slider info
		...
		setwd( "INSERT DIRECTORY PATH" )
		sliders <- read.csv("Dataset 19. sliders.amniotes.csv", row.names=1)

	#Load specimen information
		setwd( "INSERT DIRECTORY PATH" )
		specimen.info <- read.csv( "Dataset 20. specimen.info.amniotes.csv", header = TRUE )
